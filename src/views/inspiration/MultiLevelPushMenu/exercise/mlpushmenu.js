(function () {
  ...
  // returns the depth of the element "e" relative to element
  // with id=id. For this calculation only parents with
  // classname = waypoint are considered
  ...
  mlPushMenu.prototype = {
    defaults: {
      ...
      levelSpacing: 40,
      // classname for the element (if any) this when clicked closes the current level
      backClass: 'mp-back'
    },
    _init: function () {
